    ...
    async findTransactions(args) {
        ...
        for (const d of ds) {
            const r = {
                ...
                description: (0, index_all_1.verifyTruthy)(d.note || '12345'),
    ...
    async findOutputs(args) {
        ...
        for (const d of ds) {
            const r = {
                ...
                vout: (0, index_all_1.verifyInteger)(typeof d.vout !== 'number' ? 9999 : d.vout),
                satoshis: (0, index_all_1.verifyInteger)(d.amount),
                providedBy: (0, index_all_1.verifyTruthy)(d.providedBy || 'you')
                    .trim()
                    .toLowerCase()
    ...
    async findSyncStates(args) {
        ...
        for (const d of ds) {
            const r = {
                ...
                storageName: (0, index_all_1.verifyTruthy)(d.storageName || 'legacy importer')
                    .trim()
                    .toLowerCase(),
