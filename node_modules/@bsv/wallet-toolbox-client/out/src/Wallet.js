...
function throwIfAnyUnsuccessfulCreateActions(r) {
    ...
    if (!ndrs || !swrs || swrs.every(r => r.status === 'unproven'))
        return;
    throw new index_client_1.sdk.WERR_REVIEW_ACTIONS(ndrs, swrs, r.txid, r.tx, r.noSendChange);
}
function throwIfAnyUnsuccessfulSignActions(r) {
    ...
    if (!ndrs || !swrs || swrs.every(r => r.status === 'unproven'))
        return;
    throw new index_client_1.sdk.WERR_REVIEW_ACTIONS(ndrs, swrs, r.txid, r.tx);
}
